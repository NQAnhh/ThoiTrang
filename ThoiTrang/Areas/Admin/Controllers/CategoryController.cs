    ...
    public class CategoryController : Controller
    {
        ...
        public ActionResult Create(Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                category.Slug= XString.Str_slug(category.Name);
                category.Create_By = (Session["UserId"].Equals("")) ? 1 : int.Parse(Session["UserId"].ToString());
        ...
        public ActionResult Edit( Category category)
        {
            if (ModelState.IsValid)
            {
                ...
                category.Slug = XString.Str_slug(category.Name);
                category.Update_By = (Session["UserId"].Equals("")) ? 1 : int.Parse(Session["UserId"].ToString());
        ...
        public ActionResult Status(int? id)
        {
            ...
            category.Update_By = Convert.ToInt32(Session["UserId"].ToString());
            category.UpdateAt = DateTime.Now;
        ...
        public ActionResult DelTrash (int? id)
        {
            ...
            category.Status = 0; //Trang thai rac =0
            category.Update_By = Convert.ToInt32(Session["UserId"].ToString());
            category.UpdateAt = DateTime.Now;
            categoryDAO.Update(category);
            TempData["message"] = new XMessage("success", "Xóa thành công");
